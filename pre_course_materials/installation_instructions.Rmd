...
7. Move on to the [RStudio] section.
...
![Screenshot of RStudio window](/Users/mac9jc/Documents/work/TUMI/microbiome_course_2021/pre_course_materials/RStudio_image.png)
...
R packages are developed by scientists and software developers to extend base R (the built-in vocabulary and functions) to more efficiently do additional tasks. This week we will use the following packages (in no particular order):
...
To install a package from CRAN (which stands for ), you would use this format:
...
Here's what it may look like if you load "ggplot2":
...
Now let's install the packages we will use in the TUMI course. Generally, I recommend you install one package at a time, like this:
...
You can also install particular versions of a package like this:
...
install.packages(c("tidyverse","randomForest","ape","tictoc","pROC","readxl","ggpubr"))
BiocManager::install(version = '3.12')
